          ...
          <div className="mt-6 grid gap-8 lg:grid-cols-[1.15fr,0.85fr] lg:items-end">
            ...
            <div className="rounded-[1.5rem] border border-white/10 bg-black/25 p-5">
              ...
              <div className="mt-4 flex flex-wrap gap-2">
                ...
                <Link href="/studio/v2" className="inline-flex flex-1 items-center justify-center gap-2 rounded-2xl border border-fuchsia-200/20 bg-fuchsia-300/10 px-4 py-3 text-sm font-semibold text-fuchsia-100"><Network size={16} /> Studio V2</Link>
